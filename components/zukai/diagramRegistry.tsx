...
const REGISTRY: Record<string, () => React.ReactNode> = {
  ...
  // ===== 第6次拡充：カバー率40%への引き上げ =====
  ...gasEntry(['ka-q-hr-045', 'lp-q-ho-009', 'ka-q-gk-086'], () => (
    <ThreeWayCompare
      title="高圧ガスの性質による区分"
      panels={[
        { head: '可燃性ガス', items: ['燃える・爆発する', '水素・プロパン等', '火気厳禁・防爆', '爆発範囲で管理'] },
        { head: '毒性ガス', items: ['吸うと健康を害す', '塩素・アンモニア等', '除害設備が必要', '許容濃度で管理'] },
        { head: '不活性ガス', items: ['燃えず反応しにくい', '窒素・アルゴン等', 'パージに使える', '酸欠に注意'] },
      ]}
      note="⚠ 不活性でも酸素を追い出せば窒息の危険がある"
    />
  )),
  ...gasEntry(
    [
