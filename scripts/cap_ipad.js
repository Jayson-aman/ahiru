// iPad Pro 13インチ用マーケティングスクリーンショット（2064×2752px = Apple iPad Pro 13"標準サイズ）
...
const OUT = '/home/user/ahiru/store/screenshots_ipad';
fs.mkdirSync(OUT, { recursive: true });

// 2064×2752px = CSS 1032×1376 × deviceScaleFactor 2（Apple iPad Pro 13"標準サイズ）
