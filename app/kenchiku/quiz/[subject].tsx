...
const INFO: Record<string, { name: string; emoji: string; color: string; totalExpected: number }> = {
  ippan:     { name: '建築一般知識',   emoji: '🏗️', color: '#1565C0', totalExpected: 200 },
  hoki:      { name: '建築法規',       emoji: '📋', color: '#2E7D32', totalExpected: 250 },
  kucho:     { name: '空調・換気設備', emoji: '❄️', color: '#0097A7', totalExpected: 200 },
  kyuhaisui: { name: '給排水衛生設備', emoji: '🚿', color: '#1976D2', totalExpected: 200 },
  denki:     { name: '電気設備',       emoji: '⚡', color: '#F57F17', totalExpected: 150 },
  bousai:    { name: '防災設備',       emoji: '🚒', color: '#C62828', totalExpected: 150 },
};
