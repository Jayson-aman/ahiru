    ...
    <SafeAreaView style={styles.container}>
      <LinearGradient colors={['#37474F', '#1C2B33']} style={styles.header}>
        ...
        <View style={styles.examInfoRow}>
          <View style={styles.examInfoBadge}><Text style={styles.examInfoText}>1次学科 {totalQuestions}問</Text></View>
          <View style={styles.examInfoBadge}><Text style={styles.examInfoText}>1200問収録予定</Text></View>
          <View style={styles.examInfoBadge}><Text style={styles.examInfoText}>年1回（8月）</Text></View>
        </View>
