...
mansionTextbook.forEach((ch) => {
  SECTION_COUNT[ch.subject] = (SECTION_COUNT[ch.subject] ?? 0) + ch.sections.length;
});

const SUBJECTS = [
  { key: 'kubunsho', name: '区分所有法', emoji: '⚖️', color: '#7B1FA2', desc: '専有・共用部分、決議要件一覧、義務違反者への措置' },
  { key: 'tekiseika', name: 'マンション管理適正化法', emoji: '📋', color: '#1565C0', desc: '管理業者・管理業務主任者・管理計画認定制度' },
  { key: 'kiyaku', name: '標準管理規約', emoji: '📖', color: '#2E7D32', desc: '専有部分の範囲・費用負担・総会/理事会の運営' },
  { key: 'minpo', name: '民法・その他法令', emoji: '🏛️', color: '#E65100', desc: '意思表示・時効・円滑化法・品確法・頻出数値' },
  { key: 'setsubi', name: '建物・設備', emoji: '🔧', color: '#4E342E', desc: '耐震基準・劣化・給排水方式・消防設備の基準' },
  { key: 'unei', name: '管理組合の運営', emoji: '🏢', color: '#880E4F', desc: '会計仕訳・滞納対応・長期修繕計画・保険' },
];
